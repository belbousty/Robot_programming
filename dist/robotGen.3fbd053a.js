...
})({"3bwvA":[function(require,module,exports) {
"use strict";
...
parcelHelpers.export(exports, "addStar", ()=>addStar
);
parcelHelpers.export(exports, "fillBoard", ()=>fillBoard
);
...
*/ parcelHelpers.export(exports, "CreateRobot", ()=>CreateRobot
);
/*
...
*/ parcelHelpers.export(exports, "GetInstr", ()=>GetInstr
);
/*
...
parcelHelpers.export(exports, "CallF1", ()=>CallF1
);
parcelHelpers.export(exports, "CallF2", ()=>CallF2
);
parcelHelpers.export(exports, "CallF3", ()=>CallF3
);
parcelHelpers.export(exports, "CallF4", ()=>CallF4
);
parcelHelpers.export(exports, "CallF5", ()=>CallF5
);
/*
...
*/ parcelHelpers.export(exports, "stackF", ()=>stackF
);
parcelHelpers.export(exports, "getId", ()=>getId
);
parcelHelpers.export(exports, "getColor", ()=>getColor
);
parcelHelpers.export(exports, "CopyBoard", ()=>CopyBoard
);
parcelHelpers.export(exports, "removeRobot", ()=>removeRobot
);
parcelHelpers.export(exports, "addRobot", ()=>addRobot
);
/*
  Returns the puzzle after application of instruction given in parametres
*/ parcelHelpers.export(exports, "ApplyInstr", ()=>ApplyInstr
);
/*
  This export function take an array in entry then apply the instructions 
*/ parcelHelpers.export(exports, "ApplyFunction", ()=>ApplyFunction
);
parcelHelpers.export(exports, "ApplyInstrFictif", ()=>ApplyInstrFictif
);
parcelHelpers.export(exports, "ApplyFunctionStack", ()=>ApplyFunctionStack
);
/*
This export function take an array in entry then apply the instructions 
*/ parcelHelpers.export(exports, "ApplyFunctionFictif", ()=>ApplyFunctionFictif
);
parcelHelpers.export(exports, "ExecuteOneByOne", ()=>ExecuteOneByOne
);
...
function CallF1(program) {
    return program.F1;
}
function CallF2(program) {
    return program.F2;
}
function CallF3(program) {
    return program.F3;
}
function CallF4(program) {
    return program.F4;
}
function CallF5(program) {
    return program.F5;
}
function stackF(F) {
    switch(F){
...
function ApplyInstr(instruction, puzzle, aBoardID) {
    if (puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(instruction) || GetColor(instruction) === ' ' || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(instruction).toUpperCase()) puzzle.robot = GetInstr(instruction)(puzzle.robot);
...
function ApplyFunction(program, instr, puzzle, stack, aBoardID) {
    try {
        instr.forEach((ele, i)=>{
            if (puzzle.board[puzzle.robot.row][puzzle.robot.col] !== " ") {
                if (stackF(ele[0]) !== false && (GetColor(ele) === ' ' || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele) || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele).toUpperCase())) ApplyFunction(program, ele[0](program), puzzle, _stackJs.StackElement(stack, [
                    stackF(ele[0]),
                    i
                ]), aBoardID);
                else {
                    puzzle = ApplyInstr(ele, puzzle, aBoardID);
                    if (puzzle.score === 0) throw 'Break';
                }
...
function ApplyInstrFictif(instruction, puzzle) {
    if (puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(instruction) || GetColor(instruction) === ' ' || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(instruction).toUpperCase()) puzzle.robot = GetInstr(instruction)(puzzle.robot);
    let ColorOfPos = puzzle.board[puzzle.robot.row][puzzle.robot.col];
    if (ColorOfPos !== ColorOfPos.toLowerCase()) {
        puzzle.board = CopyBoard(puzzle.board, puzzle.robot.row, puzzle.robot.col, ColorOfPos.toLowerCase());
...
function ApplyFunctionStack(program, instr, puzzle, stack) {
    try {
        instr.forEach((ele, i)=>{
            if (puzzle.board[puzzle.robot.row][puzzle.robot.col] !== " ") {
                if (stackF(ele[0]) !== false && (GetColor(ele) === ' ' || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele) || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele).toUpperCase())) {
                    if (!_stackJs.StackisEmpty(stack)) {
                        _stackJs.UnstackElement(stack);
                        console.log(_stackJs.listDisp(stack));
                    }
                    if (stackF(ele) !== false) console.log(_stackJs.listDisp(_stackJs.StackElement(stack, [
                        stackF(ele),
                        i
                    ])));
                    ApplyFunctionStack(program, ele[0](program), puzzle, _stackJs.StackElement(stack, [
                        stackF(ele[0]),
                        i
                    ]));
                    if (!_stackJs.StackisEmpty(stack)) {
...
function ApplyFunctionFictif(program, instr, puzzle, stack, tableau) {
    try {
        instr.forEach((ele, i)=>{
            if (puzzle.board[puzzle.robot.row][puzzle.robot.col] !== " ") {
                if (stackF(ele[0]) !== false && (GetColor(ele) === ' ' || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele) || puzzle.board[puzzle.robot.row][puzzle.robot.col] === GetColor(ele).toUpperCase())) tableau = ApplyFunctionFictif(program, ele[0](program), puzzle, _stackJs.StackElement(stack, [
                    stackF(ele[0]),
                    i
                ]), tableau);
                else {
...
function ExecuteOneByOne(tableau, puzzle, aBoardID) {
    if (tableau.length !== 0) {
...
},{"./stack.js":"dfUzx","@parcel/transformer-js/src/esmodule-helpers.js":"az6OY"}],"dfUzx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "nil", ()=>nil
);
//Creates a stack
parcelHelpers.export(exports, "StackCons", ()=>StackCons
);
//Test if a stack is empty
parcelHelpers.export(exports, "StackisEmpty", ()=>StackisEmpty
);
//Returns the head of the stack if not empty
parcelHelpers.export(exports, "StackHead", ()=>StackHead
);
//Returns the tail of the stack if not empty
parcelHelpers.export(exports, "StackTail", ()=>StackTail
);
//Stacks "element" in "stack"
parcelHelpers.export(exports, "StackElement", ()=>StackElement
);
//Unstacks the head of the stacks then returns it if not empty
parcelHelpers.export(exports, "UnstackElement", ()=>UnstackElement
);
parcelHelpers.export(exports, "listDisp", ()=>listDisp
);
parcelHelpers.export(exports, "displayStack", ()=>displayStack
);
const nil = {};
...
},{}]},["3bwvA","2jd1e"], "2jd1e", "parcelRequired707")

//# sourceMappingURL=robotGen.3fbd053a.js.map
