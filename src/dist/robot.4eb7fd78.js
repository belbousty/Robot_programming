...
})({"jv8Of":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "b1690b904eb7fd78";
...
*/ function ApplyFunction(program, instr, puzzle2, stack, aBoardID) {
    //console.log(puzzle.score)
    try {
        instr.forEach((ele, i)=>{
            setTimeout(()=>{
                display(i);
            ...
            if (puzzle2.board[puzzle2.robot.row][puzzle2.robot.col] !== " ") {
                if (typeof ele === 'function') //console.log(listDisp(StackElement1(stack,[stackF(ele),i])));
                /*if( !(StackisEmpty1(stack)))
        {
            UnstackElement1(stack);
            console.log(listDisp1(stack))       
        } */ //console.log(listDisp(StackElement(stack,[stackF(ele),i])));
                ApplyFunction(program, ele(program), puzzle2, _stackJs.StackElement1(stack, [
                    stackF(ele),
                    i
                ]), aBoardID);
                else {
...
},{"./stack.js":"gdltS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gdltS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}]},["jv8Of","ha5Tn"], "ha5Tn", "parcelRequire94c2")

//# sourceMappingURL=robot.4eb7fd78.js.map
