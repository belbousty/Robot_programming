...
import {puzzleSolution } from "./puzzle_Sol.js";
...
window.onload = () => {
    document.
        getElementById("puzzle1").
        addEventListener("click", () => {
            aPuzzle = genPuzzle("mountains");
            aPuzzle2 = genPuzzle("mountains");
            program =  puzzleSolution("mountains");
        ...
        addRobot(aPuzzle2.robot,aBoardID);
            ...
            tableau = ApplyFunctionFictif(program, program.F1 ,aPuzzle, nil, []);
    ...
    document.
        getElementById("puzzle2").
        addEventListener("click", () => {
            fillBoard(aBoardID, aPuzzle2);
            addRobot(aPuzzle2.robot,aBoardID);
            aPuzzle = genPuzzle("windmill");
            aPuzzle2 = genPuzzle("windmill");
            program =  puzzleSolution("windmill");
            removeRobot();
            clearBoard(Boards[i]);
            i = 1;
            let items = Object.keys(program);
    ...
    document.
        getElementById("puzzle3").
        addEventListener("click", () => {
            aPuzzle = genPuzzle("star");
            aPuzzle2 = genPuzzle("star");
            program =  puzzleSolution("star");
            fillBoard(aBoardID, aPuzzle2);
            addRobot(aPuzzle2.robot,aBoardID);
            removeRobot();
            clearBoard(Boards[i]);
    ...
    document.
        getElementById("puzzle4").
        addEventListener("click", () => {
            aPuzzle = genPuzzle("0");
            aPuzzle2 = genPuzzle("0");
            program =  puzzleSolution("0");
            fillBoard(aBoardID, aPuzzle2);
            addRobot(aPuzzle2.robot,aBoardID);
            removeRobot();
            clearBoard(Boards[i]);
